...
public class MitchelMastermindv2
{
    public static void main(String[] args) {
        ...
        while (!gameDone) {
            ...
            if (currentTurn < 10) {
                System.out.println("Voer 4 VERSCHILLENDE kleuren in, gescheiden door een spatie, om de code te raden.");
